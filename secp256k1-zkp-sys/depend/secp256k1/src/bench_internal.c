...
static void bench_sha256(void* arg, int iters) {
    ...
    for (i = 0; i < iters; i++) {
        ...
        rustsecp256k1zkp_v0_11_0_sha256_write(&sha, data->data, 32);
        rustsecp256k1zkp_v0_11_0_sha256_finalize(&sha, data->data);
    }
}
...
static void bench_hmac_sha256(void* arg, int iters) {
    ...
    for (i = 0; i < iters; i++) {
        rustsecp256k1zkp_v0_11_0_hmac_sha256_initialize(&hmac, data->data, 32);
        rustsecp256k1zkp_v0_11_0_hmac_sha256_write(&hmac, data->data, 32);
        rustsecp256k1zkp_v0_11_0_hmac_sha256_finalize(&hmac, data->data);
    }
}
...
static void bench_rfc6979_hmac_sha256(void* arg, int iters) {
    ...
    for (i = 0; i < iters; i++) {
        rustsecp256k1zkp_v0_11_0_rfc6979_hmac_sha256_initialize(&rng, data->data, 64);
        rustsecp256k1zkp_v0_11_0_rfc6979_hmac_sha256_generate(&rng, data->data, 32);
    }
}
