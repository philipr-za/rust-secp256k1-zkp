...
static void generate_scalar(uint32_t num, rustsecp256k1zkp_v0_11_0_scalar* scalar) {
    ...
    rustsecp256k1zkp_v0_11_0_sha256_write(&sha256, c, sizeof(c));
    rustsecp256k1zkp_v0_11_0_sha256_finalize(&sha256, buf);
...
int main(int argc, char **argv) {
    ...
    scratch_size = rustsecp256k1zkp_v0_11_0_strauss_scratch_size(POINTS) + STRAUSS_SCRATCH_OBJECTS*16;
