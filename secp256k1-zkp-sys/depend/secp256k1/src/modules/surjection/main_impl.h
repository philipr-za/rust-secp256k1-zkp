...
static size_t rustsecp256k1zkp_v0_11_0_surjectionproof_csprng_next(rustsecp256k1zkp_v0_11_0_surjectionproof_csprng *csprng, size_t rand_max) {
    ...
    while (1) {
        ...
        if (csprng->state_i + increment >= 32) {
            ...
            rustsecp256k1zkp_v0_11_0_sha256_write(&sha, csprng->state, 32);
            rustsecp256k1zkp_v0_11_0_sha256_finalize(&sha, csprng->state);
    ...
    while (1) {
        ...
        for (i = 0; i < n_input_tags_to_use; i++) {
            while (1) {
                ...
                next_input_index = rustsecp256k1zkp_v0_11_0_surjectionproof_csprng_next(&csprng, n_input_tags);
...
int rustsecp256k1zkp_v0_11_0_surjectionproof_generate(const rustsecp256k1zkp_v0_11_0_context* ctx, rustsecp256k1zkp_v0_11_0_surjectionproof* proof, const rustsecp256k1zkp_v0_11_0_generator* ephemeral_input_tags, size_t n_ephemeral_input_tags, const rustsecp256k1zkp_v0_11_0_generator* ephemeral_output_tag, size_t input_index, const unsigned char *input_blinding_key, const unsigned char *output_blinding_key) {
    ...
    rustsecp256k1zkp_v0_11_0_surjection_genmessage(msg32, ephemeral_input_tags, n_total_pubkeys, ephemeral_output_tag);
    if (rustsecp256k1zkp_v0_11_0_surjection_genrand(borromean_s, n_used_pubkeys, &blinding_key) == 0) {
        return 0;
    }
    ...
    if (rustsecp256k1zkp_v0_11_0_borromean_sign(&ctx->ecmult_gen_ctx, &proof->data[0], borromean_s, ring_pubkeys, &nonce, &blinding_key, rsizes, indices, 1, msg32, 32) == 0) {
        return 0;
    }
...
int rustsecp256k1zkp_v0_11_0_surjectionproof_verify(const rustsecp256k1zkp_v0_11_0_context* ctx, const rustsecp256k1zkp_v0_11_0_surjectionproof* proof, const rustsecp256k1zkp_v0_11_0_generator* ephemeral_input_tags, size_t n_ephemeral_input_tags, const rustsecp256k1zkp_v0_11_0_generator* ephemeral_output_tag) {
    ...
    rustsecp256k1zkp_v0_11_0_surjection_genmessage(msg32, ephemeral_input_tags, n_total_pubkeys, ephemeral_output_tag);
    return rustsecp256k1zkp_v0_11_0_borromean_verify(NULL, &proof->data[0], borromean_s, ring_pubkeys, rsizes, 1, msg32, 32);
}
