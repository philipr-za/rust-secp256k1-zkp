...
SECP256K1_INLINE static void rustsecp256k1zkp_v0_11_0_surjection_genmessage(unsigned char *msg32, const rustsecp256k1zkp_v0_11_0_generator *ephemeral_input_tags, size_t n_input_tags, const rustsecp256k1zkp_v0_11_0_generator *ephemeral_output_tag) {
    /* compute message */
    size_t i;
    ...
    for (i = 0; i < n_input_tags; i++) {
        ...
        rustsecp256k1zkp_v0_11_0_sha256_write(&sha256_en, pk_ser, pk_len);
    }
    pk_ser[0] = 2 + (ephemeral_output_tag->data[63] & 1);
    memcpy(&pk_ser[1], &ephemeral_output_tag->data[0], 32);
    rustsecp256k1zkp_v0_11_0_sha256_write(&sha256_en, pk_ser, pk_len);
    rustsecp256k1zkp_v0_11_0_sha256_finalize(&sha256_en, msg32);
...
SECP256K1_INLINE static int rustsecp256k1zkp_v0_11_0_surjection_genrand(rustsecp256k1zkp_v0_11_0_scalar *s, size_t ns, const rustsecp256k1zkp_v0_11_0_scalar *blinding_key) {
    ...
    for (i = 0; i < ns; i++) {
        ...
        rustsecp256k1zkp_v0_11_0_sha256_initialize(&sha256_en);
        rustsecp256k1zkp_v0_11_0_sha256_write(&sha256_en, sec_input, 36);
        rustsecp256k1zkp_v0_11_0_sha256_finalize(&sha256_en, sec_input);
        rustsecp256k1zkp_v0_11_0_sha256_clear(&sha256_en);
        rustsecp256k1zkp_v0_11_0_scalar_set_b32(&s[i], sec_input, &overflow);
        if (overflow == 1) {
            rustsecp256k1zkp_v0_11_0_memclear(sec_input, 32);
            return 0;
        }
    }
    rustsecp256k1zkp_v0_11_0_memclear(sec_input, 32);
