...
static void run_schnorrsig_bench(int iters, int argc, char** argv) {
    ...
    data.keypairs = (const rustsecp256k1zkp_v0_11_0_keypair **)malloc(iters * sizeof(rustsecp256k1zkp_v0_11_0_keypair *));
    ...
    for (i = 0; i < iters; i++) {
        ...
        rustsecp256k1zkp_v0_11_0_keypair *keypair = (rustsecp256k1zkp_v0_11_0_keypair *)malloc(sizeof(*keypair));
