...
static void test_borromean(void) {
    ...
    CHECK(rustsecp256k1zkp_v0_11_0_borromean_sign(&CTX->ecmult_gen_ctx, e0, s, pubs, k, sec, rsizes, secidx, nrings, m, 32));
    CHECK(rustsecp256k1zkp_v0_11_0_borromean_verify(NULL, e0, s, pubs, rsizes, nrings, m, 32));
    i = testrand32() % c;
