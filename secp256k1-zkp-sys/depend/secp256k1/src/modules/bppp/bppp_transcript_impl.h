...
static void rustsecp256k1zkp_v0_11_0_bppp_challenge_scalar(rustsecp256k1zkp_v0_11_0_scalar* ch, const rustsecp256k1zkp_v0_11_0_sha256 *transcript, uint64_t idx) {
    unsigned char buf[32];
    rustsecp256k1zkp_v0_11_0_sha256 sha = *transcript;
    rustsecp256k1zkp_v0_11_0_bppp_le64(buf, idx);
    rustsecp256k1zkp_v0_11_0_sha256_write(&sha, buf, 8);
