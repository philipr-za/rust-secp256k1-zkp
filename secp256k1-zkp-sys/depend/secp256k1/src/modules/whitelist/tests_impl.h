...
static void test_whitelist_end_to_end(const size_t n_keys, int test_all_keys) {
    ...
    rustsecp256k1zkp_v0_11_0_pubkey *online_pubkeys = (rustsecp256k1zkp_v0_11_0_pubkey *) malloc(n_keys * sizeof(*online_pubkeys));
    rustsecp256k1zkp_v0_11_0_pubkey *offline_pubkeys = (rustsecp256k1zkp_v0_11_0_pubkey *) malloc(n_keys * sizeof(*offline_pubkeys));
