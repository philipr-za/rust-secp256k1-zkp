 ...
 */
SECP256K1_API const rustsecp256k1zkp_v0_11_0_context *rustsecp256k1zkp_v0_11_0_context_static;

/** Deprecated alias for rustsecp256k1zkp_v0_11_0_context_static. */
SECP256K1_API const rustsecp256k1zkp_v0_11_0_context *rustsecp256k1zkp_v0_11_0_context_no_precomp
 ...
 *              default handler, see rustsecp256k1zkp_v0_11_0_context_set_illegal_callback
 *              for details).
 *        data: the opaque pointer to pass to fun above, must be NULL for the default handler.
 *
...
/** Same as rustsecp256k1zkp_v0_11_0_ec_seckey_negate, but DEPRECATED. Will be removed in
 *  future versions. */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_11_0_ec_privkey_negate(
    const rustsecp256k1zkp_v0_11_0_context *ctx,
    unsigned char *seckey
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2)
  SECP256K1_DEPRECATED("Use rustsecp256k1zkp_v0_11_0_ec_seckey_negate instead");
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_11_0_ec_pubkey_negate(
    const rustsecp256k1zkp_v0_11_0_context *ctx,
    rustsecp256k1zkp_v0_11_0_pubkey *pubkey
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2);
...
/** Same as rustsecp256k1zkp_v0_11_0_ec_seckey_tweak_add, but DEPRECATED. Will be removed in
 *  future versions. */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_11_0_ec_privkey_tweak_add(
    const rustsecp256k1zkp_v0_11_0_context *ctx,
    unsigned char *seckey,
    const unsigned char *tweak32
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3)
  SECP256K1_DEPRECATED("Use rustsecp256k1zkp_v0_11_0_ec_seckey_tweak_add instead");
...
/** Same as rustsecp256k1zkp_v0_11_0_ec_seckey_tweak_mul, but DEPRECATED. Will be removed in
 *  future versions. */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_11_0_ec_privkey_tweak_mul(
    const rustsecp256k1zkp_v0_11_0_context *ctx,
    unsigned char *seckey,
    const unsigned char *tweak32
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3)
  SECP256K1_DEPRECATED("Use rustsecp256k1zkp_v0_11_0_ec_seckey_tweak_mul instead");
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_11_0_tagged_sha256(
    const rustsecp256k1zkp_v0_11_0_context *ctx,
